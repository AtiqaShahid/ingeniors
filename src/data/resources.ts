...
export const resources: Resource[] = [
  {
    ...
    content: [
      ...
      "At Ingeniors, we use FEA extensively across our structural analysis projects. Whether we're optimizing a drone frame for weight reduction or validating the load-bearing capacity of an industrial shelving system, simulation-driven design saves time, reduces costs, and produces superior products.",
  ...
  },
  {
    ...
    content: [
      ...
      "At Ingeniors, our drafting team is fully trained in GD&T per ASME Y14.5-2018. We ensure every drawing we produce communicates design intent clearly, reducing manufacturing errors and inspection ambiguities.",
    ],
  ...
  },
  {
    ...
    content: [
      ...
      "At Ingeniors, DFM is built into our design process from day one. We don't just create beautiful CAD models—we create models that can be manufactured reliably, repeatedly, and cost-effectively. Our engineers work closely with fabricators and machinists to ensure every design is production-ready.",
    ],
