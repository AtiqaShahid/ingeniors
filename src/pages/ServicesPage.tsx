...
const ServicesPage = () => {
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      <Helmet>
        <title>Services — Ingeniors Engineering Solutions</title>
        <meta name="description" content="Expert CAD design, structural analysis, 3D modeling, sheet metal design, and product visualization services by Ingeniors." />
        <link rel="canonical" href="https://ingeniors.com/services" />
      </Helmet>
      <Navbar />
                  ...
                  <Link to={`/services/${service.slug}`} className="block">
                    <div className="glass-card overflow-hidden group hover:-translate-y-1 hover:scale-[1.02] transition-all duration-300 cursor-pointer">
                      <div className="h-48 relative overflow-hidden">
                        <img src={service.thumbnail} alt={service.title} className="w-full h-full object-cover opacity-60 group-hover:opacity-80 group-hover:scale-[1.03] transition-all duration-500" loading="lazy" />
                      ...
                      <div className="p-6">
                        <h3 className="font-heading text-lg font-semibold mb-2 text-foreground group-hover:text-primary transition-colors">{service.title}</h3>
