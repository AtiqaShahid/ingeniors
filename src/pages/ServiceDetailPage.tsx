          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            >
              ...
              <img
                src={service.image}
                alt={service.title}
                className="w-full rounded-xl opacity-70 hover:opacity-90 transition-opacity duration-500 mb-10"
                loading="lazy"
              />
            </motion.div>
                ...
                {relatedServices.map((rs) => (
                  <Link key={rs!.slug} to={`/services/${rs!.slug}`} className="block">
                    <div className="glass-card p-6 group hover:-translate-y-1 transition-all duration-300">
                      ...
                      <span className="inline-flex items-center gap-1 text-primary text-sm mt-4">
